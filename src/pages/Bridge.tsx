    ...
    async function doClaim(e: any)
    {
        ...
        try {
            ...
            if (txReceipt.status === 1) {
                ...
                resetFeedback();
                setSuccess(`Transaction successfully sent! You did claimed in total ${utils.parseEther(addrInfo[1].toString())} GLQ`);
            }
        } catch (e: any) {
            resetFeedback();
